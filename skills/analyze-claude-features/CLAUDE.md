...
- Fetches 13 live documentation sources via WebFetch at runtime (code.claude.com + Notion)
...
- Uses WebFetch to pull docs at runtime — if URLs in the "Sources" section break, the gate at Step 3 will fail (≥12 of 13 required). Update the URL list in SKILL.md when Claude Code moves docs.
