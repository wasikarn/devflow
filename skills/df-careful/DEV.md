...
- Skill produces no model output; hook registration is the entire effect
...
- The Gotchas section in SKILL.md is for user awareness only, not for Claude to read.
