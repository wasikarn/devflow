...
- **Only covers build and debug runs** — ad-hoc coding sessions, manual fixes, and review-only workflows do not append to the metrics file. The report reflects structured dev-loop usage, not total Claude Code activity.
